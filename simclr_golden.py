...
class SimCLR(object):
    ...
    def info_nce_loss(self, features):
        ...
        # save_data = {
        #     "features": features.detach().cpu(),  # normalized input features
        #     "logits": logits.detach().cpu(),  # output logits
        #     "labels": labels.detach().cpu()  # output labels
        # }
        #
        # # Save to disk
        # torch.save(save_data, "info_nce_debug_88.pt")
        # print("Saved info_nce_loss debug data to info_nce_debug.pt")
        #
        # # Print shapes
        # print("== InfoNCE Debug Shapes ==")
